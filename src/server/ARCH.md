...
Combines API routing, local provider composition, and client asset serving.
Keeps client build output behind a single HTTP entrypoint.
一旦我所属的文件夹有所变化，请更新我。

| file name | position | function |
| --- | --- | --- |
| app.ts | request entrypoint | composes API handling with static asset and SPA responses |
